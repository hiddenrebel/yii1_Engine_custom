...
class CommentsController extends Controller
{
	...
	public function actionChangestatus()
	{
		...
		if(isset($_POST['id_comment']) && isset($_POST['status_comment']))
		{
		// echo($_POST['id_comment']);
			$model = $this->loadModel($_POST['id_comment']);
			// echo(json_encode($model));
			$model->status_comment = $_POST['status_comment'];
			if($model->save())
				return true;
			return false;
		}
